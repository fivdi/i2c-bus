...
assert.throws(() => {i2c.open('not an integer')}, /Invalid I2C bus number/, 'open');
assert.throws(() => {i2c.open(-1)}, /Invalid I2C bus number/, 'open');

// openSync(busNumber [, options])
assert.throws(() => {i2c.openSync('not an integer')}, /Invalid I2C bus number/, 'openSync');
assert.throws(() => {i2c.openSync(-1)}, /Invalid I2C bus number/, 'openSync');
...
// close(cb)
assert.throws(() => {i2c1.close('not a cb')}, /Invalid callback/, 'close');
...
// i2cFuncs(cb)
assert.throws(() => {i2c1.i2cFuncs('not a cb')}, /Invalid callback/, 'i2cFuncs');
...
assert.throws(() => {i2c1.readByte('not an addr', 0, () => {})}, /Invalid I2C address/, 'readByte');
assert.throws(() => {i2c1.readByte(-1, 0, () => {})}, /Invalid I2C address/, 'readByte');
assert.throws(() => {i2c1.readByte(128, 0, () => {})}, /Invalid I2C address/, 'readByte');

assert.throws(() => {i2c1.readByte(0, 'not a command', () => {})}, /Invalid I2C command/, 'readByte');
assert.throws(() => {i2c1.readByte(0, -1, () => {})}, /Invalid I2C command/, 'readByte');
assert.throws(() => {i2c1.readByte(0, 256, () => {})}, /Invalid I2C command/, 'readByte');

assert.throws(() => {i2c1.readByte(0, 0, 'not a cb')}, /Invalid callback/, 'readByte');

// readByteSync(addr, cmd)
assert.throws(() => {i2c1.readByteSync('not an addr', 0)}, /Invalid I2C address/, 'readByteSync');
assert.throws(() => {i2c1.readByteSync(-1, 0)}, /Invalid I2C address/, 'readByteSync');
assert.throws(() => {i2c1.readByteSync(128, 0)}, /Invalid I2C address/, 'readByteSync');

assert.throws(() => {i2c1.readByteSync(0, 'not a command')}, /Invalid I2C command/, 'readByteSync');
assert.throws(() => {i2c1.readByteSync(0, -1)}, /Invalid I2C command/, 'readByteSync');
assert.throws(() => {i2c1.readByteSync(0, 256)}, /Invalid I2C command/, 'readByteSync');

// readWord(addr, cmd, cb)
assert.throws(() => {i2c1.readWord('not an addr', 0, () => {})}, /Invalid I2C address/, 'readWord');
assert.throws(() => {i2c1.readWord(-1, 0, () => {})}, /Invalid I2C address/, 'readWord');
assert.throws(() => {i2c1.readWord(128, 0, () => {})}, /Invalid I2C address/, 'readWord');

assert.throws(() => {i2c1.readWord(0, 'not a command', () => {})}, /Invalid I2C command/, 'readWord');
assert.throws(() => {i2c1.readWord(0, -1, () => {})}, /Invalid I2C command/, 'readWord');
assert.throws(() => {i2c1.readWord(0, 256, () => {})}, /Invalid I2C command/, 'readWord');

assert.throws(() => {i2c1.readWord(0, 0, 'not a cb')}, /Invalid callback/, 'readWord');

// readWordSync(addr, cmd)
assert.throws(() => {i2c1.readWordSync('not an addr', 0)}, /Invalid I2C address/, 'readWordSync');
assert.throws(() => {i2c1.readWordSync(-1, 0)}, /Invalid I2C address/, 'readWordSync');
assert.throws(() => {i2c1.readWordSync(128, 0)}, /Invalid I2C address/, 'readWordSync');

assert.throws(() => {i2c1.readWordSync(0, 'not a command')}, /Invalid I2C command/, 'readWordSync');
assert.throws(() => {i2c1.readWordSync(0, -1)}, /Invalid I2C command/, 'readWordSync');
...
assert.throws(() => {i2c1.receiveByte(-1, () => {})}, /Invalid I2C address/, 'receiveByte');
assert.throws(() => {i2c1.receiveByte(128, () => {})}, /Invalid I2C address/, 'receiveByte');

assert.throws(() => {i2c1.receiveByte(0, 'not a cb')}, /Invalid callback/, 'receiveByte');

// receiveByteSync(addr)
assert.throws(() => {i2c1.receiveByteSync('not an addr')}, /Invalid I2C address/, 'receiveByteSync');
assert.throws(() => {i2c1.receiveByteSync(-1)}, /Invalid I2C address/, 'receiveByteSync');
assert.throws(() => {i2c1.receiveByteSync(128)}, /Invalid I2C address/, 'receiveByteSync');

// sendByte(addr, byte, cb)
assert.throws(() => {i2c1.sendByte('not an addr', 0, () => {})}, /Invalid I2C address/, 'sendByte');
assert.throws(() => {i2c1.sendByte(-1, 0, () => {})}, /Invalid I2C address/, 'sendByte');
assert.throws(() => {i2c1.sendByte(128, 0, () => {})}, /Invalid I2C address/, 'sendByte');

assert.throws(() => {i2c1.sendByte(0, 'not a byte', () => {})}, /Invalid byte/, 'sendByte');
assert.throws(() => {i2c1.sendByte(0, -1, () => {})}, /Invalid byte/, 'sendByte');
assert.throws(() => {i2c1.sendByte(0, 256, () => {})}, /Invalid byte/, 'sendByte');

assert.throws(() => {i2c1.sendByte(0, 0, 'not a cb')}, /Invalid callback/, 'sendByte');

// sendByteSync(addr, byte)
assert.throws(() => {i2c1.sendByteSync('not an addr', 0)}, /Invalid I2C address/, 'sendByteSync');
assert.throws(() => {i2c1.sendByteSync(-1, 0)}, /Invalid I2C address/, 'sendByteSync');
assert.throws(() => {i2c1.sendByteSync(128, 0)}, /Invalid I2C address/, 'sendByteSync');

assert.throws(() => {i2c1.sendByteSync(0, 'not a byte')}, /Invalid byte/, 'sendByteSync');
assert.throws(() => {i2c1.sendByteSync(0, -1)}, /Invalid byte/, 'sendByteSync');
assert.throws(() => {i2c1.sendByteSync(0, 256)}, /Invalid byte/, 'sendByteSync');

// writeByte(addr, cmd, byte, cb)
assert.throws(() => {i2c1.writeByte('not an addr', 0, 0, () => {})}, /Invalid I2C address/, 'writeByte');
assert.throws(() => {i2c1.writeByte(-1, 0, 0, () => {})}, /Invalid I2C address/, 'writeByte');
assert.throws(() => {i2c1.writeByte(128, 0, 0, () => {})}, /Invalid I2C address/, 'writeByte');

assert.throws(() => {i2c1.writeByte(0, 'not a command', 0, () => {})}, /Invalid I2C command/, 'writeByte');
assert.throws(() => {i2c1.writeByte(0, -1, 0, () => {})}, /Invalid I2C command/, 'writeByte');
assert.throws(() => {i2c1.writeByte(0, 256, 0, () => {})}, /Invalid I2C command/, 'writeByte');

assert.throws(() => {i2c1.writeByte(0, 0, 'not a byte', () => {})}, /Invalid byte/, 'writeByte');
assert.throws(() => {i2c1.writeByte(0, 0, -1, () => {})}, /Invalid byte/, 'writeByte');
assert.throws(() => {i2c1.writeByte(0, 0, 256, () => {})}, /Invalid byte/, 'writeByte');

assert.throws(() => {i2c1.writeByte(0, 0, 0, 'not a cb')}, /Invalid callback/, 'writeByte');

// writeByteSync(addr, cmd, byte)
assert.throws(() => {i2c1.writeByteSync('not an addr', 0, 0)}, /Invalid I2C address/, 'writeByteSync');
assert.throws(() => {i2c1.writeByteSync(-1, 0, 0)}, /Invalid I2C address/, 'writeByteSync');
assert.throws(() => {i2c1.writeByteSync(128, 0, 0)}, /Invalid I2C address/, 'writeByteSync');

assert.throws(() => {i2c1.writeByteSync(0, 'not a command', 0)}, /Invalid I2C command/, 'writeByteSync');
assert.throws(() => {i2c1.writeByteSync(0, -1, 0)}, /Invalid I2C command/, 'writeByteSync');
assert.throws(() => {i2c1.writeByteSync(0, 256, 0)}, /Invalid I2C command/, 'writeByteSync');

assert.throws(() => {i2c1.writeByteSync(0, 0, 'not a byte')}, /Invalid byte/, 'writeByteSync');
assert.throws(() => {i2c1.writeByteSync(0, 0, -1)}, /Invalid byte/, 'writeByteSync');
assert.throws(() => {i2c1.writeByteSync(0, 0, 256)}, /Invalid byte/, 'writeByteSync');

// writeWord(addr, cmd, word, cb)
assert.throws(() => {i2c1.writeWord('not an addr', 0, 0, () => {})}, /Invalid I2C address/, 'writeWord');
assert.throws(() => {i2c1.writeWord(-1, 0, 0, () => {})}, /Invalid I2C address/, 'writeWord');
assert.throws(() => {i2c1.writeWord(128, 0, 0, () => {})}, /Invalid I2C address/, 'writeWord');

assert.throws(() => {i2c1.writeWord(0, 'not a command', 0, () => {})}, /Invalid I2C command/, 'writeWord');
assert.throws(() => {i2c1.writeWord(0, -1, 0, () => {})}, /Invalid I2C command/, 'writeWord');
assert.throws(() => {i2c1.writeWord(0, 256, 0, () => {})}, /Invalid I2C command/, 'writeWord');

assert.throws(() => {i2c1.writeWord(0, 0, 'not a word', () => {})}, /Invalid word/, 'writeWord');
assert.throws(() => {i2c1.writeWord(0, 0, -1, () => {})}, /Invalid word/, 'writeWord');
assert.throws(() => {i2c1.writeWord(0, 0, 0xffff+1, () => {})}, /Invalid word/, 'writeWord');

assert.throws(() => {i2c1.writeWord(0, 0, 0, 'not a cb')}, /Invalid callback/, 'writeWord');

// writeWordSync(addr, cmd, word)
assert.throws(() => {i2c1.writeWordSync('not an addr', 0, 0)}, /Invalid I2C address/, 'writeWordSync');
assert.throws(() => {i2c1.writeWordSync(-1, 0, 0)}, /Invalid I2C address/, 'writeWordSync');
assert.throws(() => {i2c1.writeWordSync(128, 0, 0)}, /Invalid I2C address/, 'writeWordSync');

assert.throws(() => {i2c1.writeWordSync(0, 'not a command', 0)}, /Invalid I2C command/, 'writeWordSync');
assert.throws(() => {i2c1.writeWordSync(0, -1, 0)}, /Invalid I2C command/, 'writeWordSync');
assert.throws(() => {i2c1.writeWordSync(0, 256, 0)}, /Invalid I2C command/, 'writeWordSync');

assert.throws(() => {i2c1.writeWordSync(0, 0, 'not a word')}, /Invalid word/, 'writeWordSync');
assert.throws(() => {i2c1.writeWordSync(0, 0, -1)}, /Invalid word/, 'writeWordSync');
assert.throws(() => {i2c1.writeWordSync(0, 0, 0xffff+1)}, /Invalid word/, 'writeWordSync');

// writeQuick(addr, bit, cb)
assert.throws(() => {i2c1.writeQuick('not an addr', 0, () => {})}, /Invalid I2C address/, 'writeQuick');
assert.throws(() => {i2c1.writeQuick(-1, 0, () => {})}, /Invalid I2C address/, 'writeQuick');
assert.throws(() => {i2c1.writeQuick(128, 0, () => {})}, /Invalid I2C address/, 'writeQuick');

assert.throws(() => {i2c1.writeQuick(0, 'not a word', () => {})}, /Invalid bit/, 'writeQuick');
assert.throws(() => {i2c1.writeQuick(0, -1, () => {})}, /Invalid bit/, 'writeQuick');
assert.throws(() => {i2c1.writeQuick(0, 2, () => {})}, /Invalid bit/, 'writeQuick');

assert.throws(() => {i2c1.writeQuick(0, 0, 'not a cb')}, /Invalid callback/, 'writeQuick');

// writeQuickSync(addr, bit)
assert.throws(() => {i2c1.writeQuickSync('not an addr', 0)}, /Invalid I2C address/, 'writeQuickSync');
assert.throws(() => {i2c1.writeQuickSync(-1, 0)}, /Invalid I2C address/, 'writeQuickSync');
assert.throws(() => {i2c1.writeQuickSync(128, 0)}, /Invalid I2C address/, 'writeQuickSync');

assert.throws(() => {i2c1.writeQuickSync(0, 'not a word')}, /Invalid bit/, 'writeQuickSync');
assert.throws(() => {i2c1.writeQuickSync(0, -1)}, /Invalid bit/, 'writeQuickSync');
